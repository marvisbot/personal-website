...
const baseMessages: Omit<Message, "timestamp">[] = [
  ...
  },
  {
    role: "student",
    content:
      "Let's approach this step by step. First, we'll show that if odd cycles pairwise intersect, they must form a specific structure...",
    type: "proof",
  },
  {
    role: "teacher",
    content:
      "Good approach. Consider also what happens when we have three odd cycles that pairwise intersect. This will be key to proving χ(G) ≤ 5.",
    type: "critique",
  },
  {
    role: "student",
    content:
      "Here's a mathematical proof using LaTeX:\n\nLet $C_1$ and $C_2$ be odd cycles. Since they intersect at vertex $v$, we can say that $\\chi(G) \\leq 5$ because...",
    type: "proof",
  },
];
